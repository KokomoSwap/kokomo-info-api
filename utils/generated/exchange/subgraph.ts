...
export type UniswapFactoriesQueryVariables = Exact<{
...
export type UniswapFactoriesQuery = (
  ...
  & { readonly uniswapFactories: ReadonlyArray<(
    { readonly __typename?: 'UniswapFactory' }
    & Pick<UniswapFactory, 'id' | 'totalVolumeUSD' | 'totalVolumeETH' | 'untrackedVolumeUSD' | 'totalLiquidityUSD' | 'totalLiquidityETH' | 'txCount' | 'pairCount'>
  )> }
);

export type CurrentUniswapFactoriesQueryVariables = Exact<{
  factoryAddress: Scalars['ID'];
}>;


export type CurrentUniswapFactoriesQuery = (
  { readonly __typename?: 'Query' }
  & { readonly uniswapFactories: ReadonlyArray<(
    { readonly __typename?: 'UniswapFactory' }
    & Pick<UniswapFactory, 'id' | 'totalVolumeUSD' | 'totalVolumeETH' | 'untrackedVolumeUSD' | 'totalLiquidityUSD' | 'totalLiquidityETH' | 'txCount' | 'pairCount'>
